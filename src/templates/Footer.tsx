  ...
  <Background color="bg-gray-100">
    <Section>
      <CenteredFooter
        ...
        iconList={
          <>
            <Link href="https://github.com/si/petals-next">
              <a>
            ...
            <Link href="https://www.linkedin.com/groups/12719709/">
              <a title="PETALS Linkedin group">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="mailto:hello@petals.team">
              <a>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://managingengineers.net/@petals.rss">
              <a>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
